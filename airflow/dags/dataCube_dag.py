...
def set_outputPath(fce, **param):
    output_path = param['dag_run'].conf.get("output_path", "./")
    fce(output_path)
...
with  DAG(
    ...
    description="A DAG to produce a data cube population.ttl and health-care.ttl",
    schedule=None,
) as dag:
